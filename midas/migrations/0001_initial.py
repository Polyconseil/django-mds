# Generated by Django 2.1.2 on 2018-10-26 17:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', midas.models.UnboundedCharField(choices=[('POST', 'POST'), ('PUT', 'PUT'), ('DELETE', 'DELETE')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('details', django.contrib.postgres.fields.jsonb.JSONField(default=dict)),
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='midas.Area')),
            ],
            options={
                'abstract': False,
            },
